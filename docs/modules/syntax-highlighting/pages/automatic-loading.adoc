...
If you have downloaded the distribution jars only, use a command like:
 ...
 $ java -cp lib/jruby-complete-{jruby-version}.jar;lib/asciidoctorj-cli-{artifact-version}.jar;lib/asciidoctorj-api-{artifact-version}.jar;lib/asciidoctorj-{artifact-version}.jar;lib/jcommander-{jcommander-version}.jar;lib/myextension.jar org.asciidoctor.jruby.cli.AsciidoctorInvoker test.adoc
--
