...
Asciidoctor provides eighth types of extension points.
...
For example, a sub-section of the AST representing a title with a paragraf will be converted into it's correspondent HTML or PDF output.

NOTE: Some liberty is taken to make the process easier to understand.
In truth, Asciidoctor has implementation details that divert from the 3 steps above.
