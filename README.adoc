...
:artifact-version-asciidoctorj-epub3: 1.5.0-alpha.8.1
:artifact-version-asciidoctorj-pdf: 1.5.0-alpha.16
:artifact-version-asciidoctorj-diagram: 1.5.12
...
|org.asciidoctor
|asciidoctorj-epub3
|{artifact-version-asciidoctorj-epub3}
|{empty}

|org.asciidoctor
|asciidoctorj-pdf
|{artifact-version-asciidoctorj-pdf}
|{empty}

|org.asciidoctor
|asciidoctorj-diagram
|{artifact-version-asciidoctorj-diagram}
|{empty}
|===
