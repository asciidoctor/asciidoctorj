...
To start using it under Wildfly AS, you have to butcher^H^H^H^H^H^modify your Wildfly installation
...
. Copy the three Jar files cited in the <resources> section into the module
