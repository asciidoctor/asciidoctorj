...
.META-INF/services/META-INF/services/org.asciidoctor.asciidoctorj.converter.spi.ConverterRegistry
----
include::src/test/resources/converterregistry/META-INF/services/org.asciidoctor.asciidoctorj.converter.spi.ConverterRegistry[]
----
